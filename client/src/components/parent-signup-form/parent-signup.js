...
class ParentSignup extends React.Component {
  ...
  state = {
    name: '', password: '', phone: '', email: '', location: '', arabic: false,
    english: false, hebrew: false, russian: false, childAges: '',
    childSuperpowers: ''}
    ...
    handleSubmit = event => {
      ...
      arabic: false, english: false, hebrew: false, russian: false, childAges: '',
      childSuperpowers: ''});
    };
